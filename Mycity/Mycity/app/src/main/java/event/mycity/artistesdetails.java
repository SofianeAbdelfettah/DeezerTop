...
public class artistesdetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artistesdetails);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for(int i = 0 ; i < array.length() ; i++)
                            {
                                ...
                                String title = array.getJSONObject(i).getJSONObject("artist").getString("name");
                                ...
                                if(Objects.equals("Artiste : " + title, firstKeyName)) {
